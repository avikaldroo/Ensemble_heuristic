...
def apply_traversal_to_row(row , final_heur, terminated_rules_dict, value_ranges_dict,column_indices_order_list,leaf_nodes_dict,term_outcome, level = 0):
...
def implement_heur_test(test_df,final_heur, terminated_rules_dict, value_ranges_dict,column_indices_order_list,leaf_nodes_dict,term_outcome, level = 0):
    test_df['predicted_cluster'] = test_df.apply(lambda row: apply_traversal_to_row(row, final_heur, terminated_rules_dict, value_ranges_dict, column_indices_order_list, leaf_nodes_dict, term_outcome), axis=1)
    return test_df
